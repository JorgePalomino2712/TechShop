        ...
        <div className="max-w-7xl mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Tech<span className="text-[#7CB342]">Shop</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                ...
                className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-white hover:text-blue-900 transition-colors cursor-pointer"
              >
                Crear Cuenta Gratis
              </button>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">
            ¿Por qué elegir <span className="text-blue-600">TechShop</span>?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Recibe tus productos en 24-48 horas. Entregas rápidas y seguras en todo el país.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Productos seleccionados de las mejores marcas. Calidad verificada y garantizada.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Celulares */}
            <div 
              className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow cursor-pointer group"
            ...
            <div 
              className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow cursor-pointer group"
              onClick={() => navigate('/category/computadoras')}
            >
            ...
            <div 
              className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow cursor-pointer group"
              onClick={() => navigate('/category/videojuegos')}
            >
